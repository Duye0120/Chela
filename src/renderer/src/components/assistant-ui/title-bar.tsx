        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-[var(--radius-shell)] text-[color:var(--chela-text-tertiary)] transition hover:bg-[color:var(--color-control-bg-hover)] hover:text-[color:var(--chela-text-primary)]"
