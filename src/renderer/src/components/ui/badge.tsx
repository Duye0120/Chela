...
const badgeVariants = cva(
  "inline-flex select-none items-center rounded-[var(--radius-shell)] px-2.5 py-1 text-[11px] font-medium leading-none whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--color-control-focus-ring)]",
  {
    variants: {
      variant: {
        default:
          "bg-[color:var(--color-accent)] text-[color:var(--chela-text-inverse)] shadow-[var(--color-control-shadow)]",
